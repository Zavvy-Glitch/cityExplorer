...
render() {
  return(
      ...
      {this.props.movie.map((value, idx) =>
        <Card id="Movies" bg="Dark" key={idx} style={{ width: '30rem' }} border="Dark">
          <Card.Body>
          <Card.Text id="movieTitle">{value.title}</Card.Text>
          <Card.Text><img src={`https://image.tmdb.org/t/p/w154/${value.imageUrl}`} alt={this.props.searchQuery}/></Card.Text>
